...
In the [previous post]({% post_url 2013-04-21-joyous-tree-friends %}) I was struggling with the noise generated in my code by stack manipulation-related functions. Having reached a dead end, I promised you a new shining path, which I'll be introducing in this post.
